...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Bseh-pzX.mjs");
...
var manifest = {
	"0c43127253ff3ddf0fc5271e1e11cf5ff5b3a545bd03fbfb926e046073ba8141": {
		functionName: "listMyTrips_createServerFn_handler",
		importer: () => import("./api-DdZ2NGCW.mjs")
	},
	"2c423f300cc00639b0b06a7d02c739d0e078febd3b07f98a593dd3655926bff6": {
		functionName: "patchTrip_createServerFn_handler",
		importer: () => import("./api-DdZ2NGCW.mjs")
	},
	"3457561740fa67d06d4cd584c53e94b0e881e7c68c1e3733c1a12b4c46feb1af": {
		functionName: "getMyProfile_createServerFn_handler",
		importer: () => import("./api-DdZ2NGCW.mjs")
	},
	"77429f7d7bce703d49601fd7c715f6cfbea1c584c633d68b47742bdfd91e95b0": {
		functionName: "saveMyRole_createServerFn_handler",
		importer: () => import("./api-DdZ2NGCW.mjs")
	},
	"fe730404e488612ecf0679ac92905b0afbf2134b8ce2c9027d24d032e7683ea8": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BviyUA3V.mjs").then((n) => n.t),
